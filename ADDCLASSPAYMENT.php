...
if (isset($_POST['submitBtn']))
{
	...
	$total = $_POST['totalfees'];
	


	$inserts="INSERT INTO class(id_viewCLASS,course,year,registration,tuition,laboratory,library,entrance,counceling,falp,med_dental,univsbo,univorgan,journal,fine,athletics,pe,id,nstp,sociocultural,total) 
	VALUES (NULL, '$course', '$year','$registration', '$tuition', '$laboratory', '$library', '$entrance', '$counceling', '$falp', '$med_dental', '$univsbo','$univorgan', '$journal', '$fine', '$athletics', '$pe', '$id', '$nstp', '$sociocultural', '$total')";
